...
#get a list of lanuch sites
lns=spacex_df['Launch Site'].unique()
dropdown_options=[ {'label': 'All Sites', 'value': 'ALL'}] 
for x in lns:
    dropdown_options.append({'label':x,'value':x})
...
def get_scatter_chart(entered_site,payload):
    ...
    if entered_site=="ALL":
        ...
        fig = px.scatter(filtered_df,x='Payload Mass (kg)', y='class',color='Booster Version Category',title=f"Correlation between Payload mass and Success for site {entered_site}")
        return fig
